...
describe('Theme Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should update editForm', () => {
      ...
      expect(comp.editForm.value).toEqual(expect.objectContaining(theme));
    });
  });
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<Theme>>();
      const theme = { id: 123 };
      ...
      expect(themeService.update).toHaveBeenCalledWith(theme);
    ...
    it('Should call create service on save for new entity', () => {
      ...
      // THEN
      expect(themeService.create).toHaveBeenCalledWith(theme);
      expect(comp.isSaving).toEqual(false);
      expect(comp.previousState).toHaveBeenCalled();
    });
